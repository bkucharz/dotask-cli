...
def test_delete_task_removes_task():
    tasks = [Task(1, "Test task", "todo", "2025-01-01 10:00:00", "2025-01-01 10:00:00")]
    delete_task(tasks, 1)
    assert len(tasks) == 0
...
def test_update_task_changes_status():
    task = Task(1, "Learn pytest", "todo", "2025-01-01 10:00:00", "2025-01-01 10:00:00")
    tasks = [task]
...
def test_save_file_writes_json():
    tasks = [Task(1, "Task 1", "todo", "2024-07-10 10:00:00", "2024-07-10 10:00:00")]
    m = mock_open()
